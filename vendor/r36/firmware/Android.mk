...
ifeq ($(TARGET_TEGRA_FIRMWARE_BRANCH),r36)
...
include $(CLEAR_VARS)
LOCAL_MODULE               := fecs_pkc_sig_encrypt
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/ga10b/fecs_pkc_sig_encrypt.bin
LOCAL_MODULE_SUFFIX        := .bin
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_PATH          := $(TARGET_OUT_VENDOR)/firmware/nvidia/ga10b
LOCAL_MODULE_TAGS          := optional
...
include $(CLEAR_VARS)
LOCAL_MODULE               := gpccs_pkc_sig_encrypt
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/ga10b/gpccs_pkc_sig_encrypt.bin
LOCAL_MODULE_SUFFIX        := .bin
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_PATH          := $(TARGET_OUT_VENDOR)/firmware/nvidia/ga10b
LOCAL_MODULE_TAGS          := optional
...
include $(CLEAR_VARS)
LOCAL_MODULE               := NETB_img_prod_encrypted
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/ga10b/NETB_img_prod_encrypted.bin
LOCAL_MODULE_SUFFIX        := .bin
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_PATH          := $(TARGET_OUT_VENDOR)/firmware/nvidia/ga10b
LOCAL_MODULE_TAGS          := optional
...
include $(CLEAR_VARS)
LOCAL_MODULE               := NETD_img_prod_encrypted
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/ga10b/NETD_img_prod_encrypted.bin
LOCAL_MODULE_SUFFIX        := .bin
LOCAL_MODULE_CLASS         := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE               := safety-scheduler.data.encrypt.bin.prod
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/ga10b/safety-scheduler.data.encrypt.bin.prod
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_PATH          := $(TARGET_OUT_VENDOR)/firmware/nvidia/ga10b
LOCAL_MODULE_TAGS          := optional
LOCAL_MODULE_OWNER         := nvidia
...
include $(CLEAR_VARS)
LOCAL_MODULE               := safety-scheduler.manifest.encrypt.bin.out.bin.prod
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/ga10b/safety-scheduler.manifest.encrypt.bin.out.bin.prod
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_PATH          := $(TARGET_OUT_VENDOR)/firmware/nvidia/ga10b
LOCAL_MODULE_TAGS          := optional
LOCAL_MODULE_OWNER         := nvidia
...
include $(CLEAR_VARS)
LOCAL_MODULE               := safety-scheduler.text.encrypt.bin.prod
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/ga10b/safety-scheduler.text.encrypt.bin.prod
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_PATH          := $(TARGET_OUT_VENDOR)/firmware/nvidia/ga10b
LOCAL_MODULE_TAGS          := optional
LOCAL_MODULE_OWNER         := nvidia
...
include $(CLEAR_VARS)
LOCAL_MODULE               := nvhost_tsec_desc
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/tegra23x/nvhost_tsec_desc.fw
LOCAL_MODULE_SUFFIX        := .fw
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_PATH          := $(TARGET_OUT_VENDOR)/firmware/tegra23x
LOCAL_MODULE_TAGS          := optional
...
include $(CLEAR_VARS)
LOCAL_MODULE               := nvhost_tsec_riscv
LOCAL_SRC_FILES            := $(T234_FIRMWARE_PATH)/tegra23x/nvhost_tsec_riscv.fw
LOCAL_MODULE_SUFFIX        := .fw
LOCAL_MODULE_CLASS         := ETC
LOCAL_MODULE_PATH          := $(TARGET_OUT_VENDOR)/firmware/tegra23x
LOCAL_MODULE_TAGS          := optional
